          ...
          <div className="flex flex-wrap items-center justify-between -mx-4">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0">
                ...
                Con más de 10 años de experiencia en servicios notariales y trámites migratorios. Nos encargamos de que tus documentos estén en regla y tus procesos avancen sin problemas.
                </p>
