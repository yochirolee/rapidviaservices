...
const BenefitSection: React.FC<Props> = ({ benefit, imageAtRight }: Props) => {
  ...
  return (
    <section className="benefit-section">
      <motion.div
        className="flex flex-wrap flex-col items-center justify-center gap-2 px-4 sm:px-6 md:px-8 lg:flex-row lg:gap-20 lg:flex-nowrap mb-24"
        ...
        >
          <div className="w-full text-center lg:text-left">
            <motion.div className="flex flex-col w-full" variants={childVariants}>
              <SectionTitle>
                <h2 className="lg:max-w-2xl text-3xl md:text-4xl font-bold leading-tight">
                  {title}
                </h2>
              </SectionTitle>

              <p className="mt-2 mx-auto lg:ml-0 text-base leading-relaxed text-body-color">
                {description}
              </p>
            </motion.div>
